    ...
    <div class="w-full max-w-sm mx-4" x-data="{ showPass: false, loading: false }">
        ...
        <div class="glass rounded-2xl p-7">
            ...
            <div class="mb-4 p-3 bg-green-500/10 border border-green-500/20 rounded-lg">
                <p class="text-green-400 text-xs"><?php echo e(session('status')); ?></p>
            </div>
            <?php endif; ?>

            <form method="POST" action="<?php echo e(route('login')); ?>" @submit="loading = true" class="space-y-4">
                <?php echo csrf_field(); ?>
                ...
                <div class="flex items-center justify-between text-xs">
                    ...
                    <a href="<?php echo e(route('password.request')); ?>" class="text-blue-400 hover:text-blue-300 transition-colors">
                        Forgot password?
                    </a>
                </div>
        ...
        <p class="text-center text-xs text-slate-600 mt-6">
            &copy; <?php echo e(date('Y')); ?> LeaveSphere · Kelompok 7 · Telkom University
        </p>
    </div>
...
<?php /**PATH C:\laragon\www\leavesphere\resources\views/auth/login.blade.php ENDPATH**/ ?>