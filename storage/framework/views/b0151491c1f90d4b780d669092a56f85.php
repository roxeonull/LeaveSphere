<?php $__env->startSection('title', 'Team Calendar'); ?>
<?php $__env->startSection('page-title', 'Team Calendar'); ?>
...
function calendarPage() {
    return {
        ...
        buildEventsUrl() {
            ...
            return `<?php echo e(route('calendar.events')); ?>?${params.toString()}`;
        },
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\leavesphere\resources\views/calendar/index.blade.php ENDPATH**/ ?>