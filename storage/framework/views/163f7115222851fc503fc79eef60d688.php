    ...
    <div class="flex gap-6">
        ...
        <div class="w-48 flex-shrink-0">
            <nav class="space-y-1">
                ...
                <button @click="activeTab = '<?php echo e($item['tab']); ?>'"
                    :class="activeTab === '<?php echo e($item['tab']); ?>' ? 'bg-blue-50 dark:bg-blue-900/20 text-blue-600 border-l-2 border-blue-500' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700'"
        ...
        <div class="flex-1 space-y-5">
            ...
            <div x-show="activeTab === 'notifications'" class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-6 space-y-5">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-start justify-between py-3 border-b border-gray-50 dark:border-gray-700 last:border-0">
                        <div>
                            <p class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e($notif['label']); ?></p>
                            <p class="text-xs text-gray-400 mt-0.5"><?php echo e($notif['desc']); ?></p>
                        </div>
            ...
            <div x-show="activeTab === 'leave-policy'" class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-6 space-y-5">
                ...
                <div class="grid grid-cols-2 gap-5">
                    ...
                    <div>
                        <label class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1.5"><?php echo e($policy['label']); ?></label>
                        <input type="number" name="<?php echo e($policy['name']); ?>" value="<?php echo e($policy['value']); ?>"
                            class="w-full bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:border-blue-400">
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            ...
            <div x-show="activeTab === 'sla'" class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-6 space-y-5">
                ...
                <div class="grid grid-cols-2 gap-5">
                    ...
                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sla): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div>
                        <label class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1.5"><?php echo e($sla['label']); ?></label>
                        <input type="number" name="<?php echo e($sla['name']); ?>" value="<?php echo e($sla['value']); ?>"
                            class="w-full bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:border-blue-400">
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\leavesphere\resources\views/settings/index.blade.php ENDPATH**/ ?>