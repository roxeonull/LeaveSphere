...
<?php $__env->startSection('page-title', 'Admin Overview'); ?>
        ...
        <div class="stat-card bg-white dark:bg-gray-800 rounded-xl p-5 border border-gray-200 dark:border-gray-700 shadow-sm">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 dark:text-white mt-1"><?php echo e($stats['pending_approvals'] ?? 24); ?></p>
        ...
        <div class="stat-card bg-white dark:bg-gray-800 rounded-xl p-5 border border-gray-200 dark:border-gray-700 shadow-sm">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 dark:text-white mt-1"><?php echo e($stats['sla_alerts'] ?? 8); ?></p>
        ...
        <div class="stat-card bg-white dark:bg-gray-800 rounded-xl p-5 border border-gray-200 dark:border-gray-700 shadow-sm">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 dark:text-white mt-1"><?php echo e($stats['spike_percentage'] >= 0 ? '+' : ''); ?><?php echo e($stats['spike_percentage']); ?>%</p>
                    <p class="text-xs <?php echo e($stats['spike_percentage'] >= 0 ? 'text-amber-600' : 'text-green-600'); ?> mt-1 flex items-center gap-1">
                        <i data-lucide="trending-up" class="w-3 h-3"></i>
                        vs previous 7 days
                    </p>
                </div>
        ...
        <div class="stat-card bg-white dark:bg-gray-800 rounded-xl p-5 border border-gray-200 dark:border-gray-700 shadow-sm">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 dark:text-white mt-1"><?php echo e($stats['total_employees'] ?? 156); ?></p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="divide-y divide-gray-50 dark:divide-gray-700">
                ...
                <div class="flex items-center justify-between px-5 py-3.5 hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                    <div class="flex items-center gap-3">
                        <div class="w-8 h-8 <?php echo e($req['color']); ?> rounded-full flex items-center justify-center text-white text-xs font-bold flex-shrink-0">
                            <?php echo e($req['initials']); ?>

                        </div>
                        <div>
                            <p class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e($req['name']); ?></p>
                            <p class="text-xs text-gray-400"><?php echo e($req['type']); ?> · <?php echo e($req['days']); ?></p>
                        </div>
                    </div>
                    <div class="flex items-center gap-3">
                        <span class="text-xs text-gray-400"><?php echo e($req['date']); ?></span>
                        <a href="<?php echo e(route('approvals.index')); ?>"
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
            <div class="flex items-center justify-between px-5 py-4 border-b border-gray-100 dark:border-gray-700">
                ...
                <a href="<?php echo e(route('sla.index')); ?>"
                   class="text-xs text-blue-600 hover:text-blue-700 flex items-center gap-1 font-medium">
                    View All <i data-lucide="arrow-right" class="w-3 h-3"></i>
                </a>
            </div>
                ...
                <div class="flex items-center justify-between px-5 py-4 hover:bg-gray-50 dark:hover:bg-gray-700/30">
                    <div class="flex items-center gap-3">
                        <div class="w-8 h-8 rounded-full flex items-center justify-center text-white text-xs font-bold flex-shrink-0
                            <?php echo e($alert['level'] === 'danger' ? 'bg-red-500' : ($alert['level'] === 'warning' ? 'bg-amber-500' : 'bg-green-500')); ?>">
                            <?php echo e($alert['initials']); ?>

                        </div>
                        <div>
                            <p class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e($alert['name']); ?></p>
                            <p class="text-xs text-gray-400"><?php echo e($alert['type']); ?></p>
                        </div>
                    </div>
                    <span class="text-xs font-semibold px-2.5 py-1 rounded-full
                        <?php echo e($alert['level'] === 'danger' ? 'bg-red-100 text-red-700' : ($alert['level'] === 'warning' ? 'bg-amber-100 text-amber-700' : 'bg-green-100 text-green-700')); ?>">
                        <?php echo e($alert['time']); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    // Leave Spikes Chart
    fetch('<?php echo e(route("dashboard.spikes-data")); ?>')
        .then(res => res.json())
        .then(data => {
    ...
    // Department Load Chart
    fetch('<?php echo e(route("dashboard.department-load-data")); ?>')
        .then(res => res.json())
        .then(data => {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\leavesphere\resources\views/dashboard/index.blade.php ENDPATH**/ ?>